                ...
                <div className="w-[350px] h-[300px] mt-2 rounded-[12px] absolute right-0" datatype="non-visible" id="y-connect-wallet-dropdown">
                    <GradientDiv>
                        <div className="w-full h-full p-3 font-sf-light bg-background rounded-[12px] flex flex-col justify-around">
                            ...
                            <div className="flex items-center w-[95%] border-text border m-auto hover:cursor-pointer hover:bg-button-light-rgb rounded-full p-2" onClick={() => connectWallet("metamask")}>
                                <div className="w-[90%] h-full rounded-full flex items-center">
                                    <img src="/images/metamask.png" alt="Arbitrum Image" className="w-[25px] h-[25px] rounded-full" /> <span className="ml-3">Metamask</span>
                                </div>
                                <MdKeyboardArrowRight className="text-2xl" />
                            </div>

                            <div className="flex items-center w-[95%] border-text border m-auto hover:cursor-pointer hover:bg-button-light-rgb rounded-full p-2" onClick={() => connectWallet("rabby")}>
                                <div className="w-[90%] h-full rounded-full flex items-center">
                                    <img src="/images/rabby.png" alt="Arbitrum Image" className="w-[25px] h-[25px] rounded-full" /> <span className="ml-3">Rabby</span>
                                </div>
                                <MdKeyboardArrowRight className="text-2xl" />
                            </div>

                            <div className="flex items-center w-[95%] border-text border m-auto hover:cursor-pointer hover:bg-button-light-rgb rounded-full p-2" onClick={() => connectWallet("coinbase")}>
                                <div className="w-[90%] h-full rounded-full flex items-center">
                                    <img src="/images/coinbase.webp" alt="Arbitrum Image" className="w-[25px] h-[25px] rounded-full" /> <span className="ml-3">Coinbase</span>
                                </div>
                                <MdKeyboardArrowRight className="text-2xl" />
                            </div>

                            <div className="flex items-center w-[95%] border-text border m-auto hover:cursor-pointer hover:bg-button-light-rgb rounded-full p-2" onClick={() => connectWallet("walletConnect")}>
                                <div className="w-[90%] h-full rounded-full flex items-center">
                                    <img src="/images/wallet-connect.jpeg" alt="Arbitrum Image" className="w-[25px] h-[25px] rounded-full" /> <span className="ml-3">Wallet Connect</span>
                                </div>
                                <MdKeyboardArrowRight className="text-2xl" />
                            </div>
                        </div>
