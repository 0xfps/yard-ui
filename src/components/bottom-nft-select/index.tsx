...
export default function BottomNFTSelect() {
    ...
    const { selectedNFTImage } = useSwapData()
    ...
    return (
        <div className="w-[100%] h-[145px] bg-[#192126] rounded-[12px] p-8 flex justify-between items-center">
            ...
            <div className={`w-[250px] h-[45px] rounded-[12px] text-xs font-sf-light ${!isConnected ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}`}>
                <GradientDiv>
